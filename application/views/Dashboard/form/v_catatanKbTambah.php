<div class="content-wrapper">
	<section class="content-header">
		<h1>
			FORM TAMBAH DATA CATATN KB
			<small>isi Data Catatan KB Pasien</small>
		</h1>
	</section>
	<section class="content">
		<a href="<?php echo base_url() . 'dashboard/catatanKb'; ?>" class="btn btn btn-primary">Kembali</a>
		<br />
		<br />
		<form method="post" action="<?php echo base_url('dashboard/catatanKb_aksi') ?>">
			<div class="row">
				<div class="col-lg-12">
					<div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                <input type="text" name="namaPasien" id="" class="form-control">
                            </div>
                            <a href="#" class="btn btn btn-success">Cari</a>
